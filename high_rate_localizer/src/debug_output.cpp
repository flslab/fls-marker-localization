  ...
  return {
      ...
      {"config",
       {{"initial_distance", config_.tracking.initial_distance_m},
        ...
        {"processing_crop",
         {{"enabled", config_.processing_crop.enabled},
          {"x", config_.processing_crop.x},
          {"y", config_.processing_crop.y},
          {"width", config_.processing_crop.width},
          {"height", config_.processing_crop.height}}},
