...
MarkerTracker::MarkerTracker(double bit_duration_ms, int payload_size,
    ...
    : bit_duration_ms_(bit_duration_ms), payload_size_(payload_size), tracking_threshold_(tracking_threshold), sync_threshold_(sync_threshold), static_markers_mode_(static_markers), validate_mode_(validate), dark_blob_intensity_(dark_intensity), retire_missing_edge_tracks_(retire_missing_edge_tracks) {}
